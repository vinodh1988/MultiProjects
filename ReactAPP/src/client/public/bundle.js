...
var Main = function (_React$Component) {
    ...
    function Main() {
        ...
        _this.state = { fruits: ['Apple', 'Orange', 'Banana'],
    ...
    _createClass(Main, [{
        ...
        value: function updateCode() {
            this.state.code = _reactDom2.default.findDOMNode(this.refs.code).value;
            this.setState(this.state);
        }
    }, {
        key: 'addProduct',
        value: function addProduct() {
            var temp = _reactDom2.default.findDOMNode(this.refs.data).value;
            var type = _reactDom2.default.findDOMNode(this.refs.type).value;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h3',
                        null,
                        'This component is built as part of trainig'
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
                        ...
                        _react2.default.createElement('input', { type: 'button', value: 'Store data', onClick: this.addProduct }),
                        'add Code ',
                        _react2.default.createElement('input', { type: 'text', ref: 'code', onKeyUp: this.updateCode }),
                        _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.code } })
                    ),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement('br', null),
                    _react2.default.createElement(_form.Form, null)
                ),
                _react2.default.createElement(_box.Box, { title: 'Fruits', list: this.state.fruits }),
                _react2.default.createElement(_box.Box, { title: 'Vegetables', list: this.state.vegies }),
                _react2.default.createElement(_box.Box, { title: 'Spices', list: this.state.spices }),
                _react2.default.createElement(_box.Box, { title: 'Pulses', list: this.state.pulses })
            );
        }
    }, {
...
var Form = exports.Form = function (_React$Component) {
  ...
  _createClass(Form, [{
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              null,
              _react2.default.createElement('input', { type: 'text', ref: 'newsid' })
            )
          ),
          _react2.default.createElement(
            'tr',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              null,
              ' ',
              _react2.default.createElement('textarea', { ref: 'article' }),
              ' '
            )
          ),
          _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              null,
              _react2.default.createElement('input', { type: 'text', ref: 'image' })
            )
          ),
          _react2.default.createElement(
            'tr',
            ...
            _react2.default.createElement(
              'td',
              { colspan: '2' },
              _react2.default.createElement('input', { type: 'button', value: 'upload article', onClick: this.saveNews })
            )
          )
        ),
        _react2.default.createElement(
    ...
    value: function saveNews() {
      var newsid = _reactDom2.default.findDOMNode(this.refs.newsid).value;
      var title = _reactDom2.default.findDOMNode(this.refs.title).value;
      var article = _reactDom2.default.findDOMNode(this.refs.article).value;
      var image = _reactDom2.default.findDOMNode(this.refs.image).value;
      var type = _reactDom2.default.findDOMNode(this.refs.type).value;
      var date = new Date();
      if (newsid == undefined || newsid.length === 0 || title == undefined || title.length === 0 || article == undefined || article.length < 30 || image == undefined || image.length === 0) this.state.validation = "Please properly enter all the fields";else {
        this.state.validation = "All fields enterered";
        var object = { newsid: newsid, title: title, article: article, image: image,
          type: type, date: date };
        _superagent2.default.post('http://localhost:3000/news').send(object).set('Accept', 'application/json').end(function (err, res) {
          if (err || !res.ok) {
            alert('Oh no! error');
          } else {
